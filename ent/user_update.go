...
func (uu *UserUpdate) SetMyuuid(s string) *UserUpdate {
	uu.mutation.SetMyuuid(s)
	return uu
}
...
// SetMyuuid sets the "myuuid" field.
func (uuo *UserUpdateOne) SetMyuuid(s string) *UserUpdateOne {
	uuo.mutation.SetMyuuid(s)
	return uuo
}
